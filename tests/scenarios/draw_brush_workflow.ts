...
export const draw_brush_workflow: E2EScenario = {
    id: 'draw_brush_workflow',
    name: 'Brush Tool Workflow',
    description: 'Verify brush tool logic across the sprite editor canvas.',
    setup: [
