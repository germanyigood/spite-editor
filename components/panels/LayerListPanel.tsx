...
const LayerListPanel: React.FC<LayerListPanelProps> = ({ layers, onImportFile, onRemoveLayer }) => {
  return (
    <div className="space-y-3">
        ...
        <div className="space-y-1">
            {layers.map((layer) => (
                <div key={layer.id} className="flex items-center gap-2 bg-gray-800 p-2 rounded text-xs group border border-transparent hover:border-gray-600">
